...
public class ForecastFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setHasOptionsMenu(true);    //Indicate that we want callbacks for these methods.
    }
    @Override
    public void onCreateOptionsMenu(Menu menu,MenuInflater inflater){ //inflates the layout we defined
